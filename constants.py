...
SPINNER_TEXT = "回答生成中..."
SPINNER_CONTACT_TEXT = (
    "問い合わせ内容を弊社担当者に送信中です。画面を操作せず、このままお待ちください。"
)
...
FEEDBACK_YES_MESSAGE = (
    "ご満足いただけて良かったです！他にもご質問があれば、お気軽にお尋ねください！"
)
...
SYSTEM_PROMPT_NOTICE_SLACK = """
    ...
    - 【メンション先の選定理由】について、以下の条件に従って生成してください。
        - メンバーIDが{slack_id_text}の各メンバー宛に通知を飛ばした理由を
        各従業員ごとに改行区切りで具体的に生成してください。
